...
import com.phoenix.p2pcamserver.streaming.rtp.AbstractPacketizer;
import com.phoenix.p2pcamserver.streaming.audio.AudioQuality;
import com.phoenix.p2pcamserver.streaming.rtp.RtpSocket;
...
public abstract class MediaStream implements Stream {
	...
	protected void createSockets() throws IOException {
		...
		final String LOCAL_ADDR = "com.phoenix.p2pcamserver.streaming-";
