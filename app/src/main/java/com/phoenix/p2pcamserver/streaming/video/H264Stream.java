...
package com.phoenix.p2pcamserver.streaming.video;
...
import com.phoenix.p2pcamserver.streaming.hw.EncoderDebugger;
import com.phoenix.p2pcamserver.streaming.mp4.MP4Config;
import com.phoenix.p2pcamserver.streaming.rtp.H264Packetizer;
...
import com.phoenix.p2pcamserver.streaming.MediaStream;
...
public class H264Stream extends VideoStream {
	...
	private MP4Config testH264() throws IllegalStateException, IOException {
		if (mMode != MediaStream.MODE_MEDIARECORDER_API) return testMediaCodecAPI();
	...
	private MP4Config testMediaRecorderAPI() throws RuntimeException, IOException {
		String key = MediaStream.PREF_PREFIX+"h264-mr-"+mRequestedQuality.framerate+","+mRequestedQuality.resX+","+mRequestedQuality.resY;
